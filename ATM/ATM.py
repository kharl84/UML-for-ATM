import sqlite3
import random
from technician import Technician  # Importing the Technician class
...
def technician_operations(atm, technician):
    ...
    if operation == "1":
        technician().perform_maintenance(atm)  # Create an instance of Technician and call the method
    elif operation == "2":
...
def main():
    ...
    while True:
        ...
        if selection == "1":
            ...
            technician_operations(atm, Technician)  # Pass Technician class to the function
        elif selection == "5":
